...
pub struct Channel {
    ...
    pub local_constraints: ::std::option::Option<ChannelConstraints>,
    /// List constraints for the remote node.
    #[prost(message, optional, tag = "30")]
    pub remote_constraints: ::std::option::Option<ChannelConstraints>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ChannelBalanceResponse {
    ...
    #[prost(message, optional, tag = "3")]
    pub local_balance: ::std::option::Option<Amount>,
    /// Sum of channels remote balances.
    #[prost(message, optional, tag = "4")]
    pub remote_balance: ::std::option::Option<Amount>,
    /// Sum of channels local unsettled balances.
    #[prost(message, optional, tag = "5")]
    pub unsettled_local_balance: ::std::option::Option<Amount>,
    /// Sum of channels remote unsettled balances.
    #[prost(message, optional, tag = "6")]
    pub unsettled_remote_balance: ::std::option::Option<Amount>,
    /// Sum of channels pending local balances.
    #[prost(message, optional, tag = "7")]
    pub pending_open_local_balance: ::std::option::Option<Amount>,
    /// Sum of channels pending remote balances.
    #[prost(message, optional, tag = "8")]
    pub pending_open_remote_balance: ::std::option::Option<Amount>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ListPermissionsResponse {
    ...
    pub method_permissions:
        ::std::collections::HashMap<std::string::String, MacaroonPermissionList>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Failure {
