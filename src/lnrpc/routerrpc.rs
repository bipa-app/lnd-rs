...
pub struct SendToRouteRequest {
    ...
    pub route: ::std::option::Option<super::lnrpc::Route>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SendToRouteResponse {
    ...
    #[prost(message, optional, tag = "2")]
    pub failure: ::std::option::Option<super::lnrpc::Failure>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct QueryMissionControlResponse {
    ...
    pub pairs: ::std::vec::Vec<PairHistory>,
}
...
pub struct PairHistory {
    ...
    pub history: ::std::option::Option<PairData>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PairData {
...
pub struct BuildRouteRequest {
    ...
    pub hop_pubkeys: ::std::vec::Vec<std::vec::Vec<u8>>,
    /// An optional payment addr to be included within the last hop of the route.
    #[prost(bytes, tag = "5")]
    pub payment_addr: std::vec::Vec<u8>,
}
...
pub struct HtlcEvent {
    ...
    pub event: ::std::option::Option<htlc_event::Event>,
}
pub mod htlc_event {
...
pub struct ForwardEvent {
    ...
    #[prost(message, optional, tag = "1")]
    pub info: ::std::option::Option<HtlcInfo>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct PaymentStatus {
    ...
    pub htlcs: ::std::vec::Vec<super::lnrpc::HtlcAttempt>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ForwardHtlcInterceptRequest {
    ...
    #[prost(message, optional, tag = "1")]
    pub incoming_circuit_key: ::std::option::Option<CircuitKey>,
...
pub mod router_client {
    ...
    impl<T> std::fmt::Debug for RouterClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "RouterClient {{ ... }}")
        }
    }
}
